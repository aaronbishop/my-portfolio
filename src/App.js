...
const PROJECTS = [
    ...
    {
        name: "NavyPal",
        description: "Contributed to the NavyPal project, the intended replacement for the software used in Navy mess halls. I created a Windows installer and contributed to the C# codebase, helping modernize deployment and improve maintainability.",
